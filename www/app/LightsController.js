define(['app'], function (app) {
	app.controller('LightsController', [ '$scope', '$rootScope', '$location', '$http', '$interval', 'permissions', function($scope,$rootScope,$location,$http,$interval,permissions) {
		...
		UpdateAddManualDialog = function()
		{
			...
			var bIsARCType=((lighttype<20)||(lighttype==101)||(lighttype==74));
			var bIsType5=0;
			
			var tothousecodes=1;
			var totunits=1;
			if ((lighttype==0)||(lighttype==1)||(lighttype==3)||(lighttype==101)||(lighttype==74)) {
				tothousecodes=16;
				totunits=16;
			}
		...
		GetManualLightSettings = function(isTest)
		{
			...
			else if ((lighttype<20)||(lighttype==101)||(lighttype==74)) {
